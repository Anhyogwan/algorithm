package com.ssafy.recur.BOJ.sol17478;
...
public class BOJ_17478_재귀함수가뭔가요 {
	...
	static void anw(int num) {
		if(num == 0) {
			System.out.println(bar + s1);
			System.out.println(bar + "\"재귀함수는 자기 자신을 호출하는 함수라네\"");
			return;
		}
		System.out.println(bar + s1);
		System.out.println(bar + s2);
		System.out.println(bar + s3);
		System.out.println(bar + s4);
		bar += "____";
		anw(num - 1);
